...
const CreateEditTopicDialog = ({
  topicToEdit,
  onDismiss,
  onTopicSaved,
}: CreateEditTopicDialogProps) => {
  ...
  return (
    <Modal show onHide={onDismiss}>
      <Modal.Header closeButton>
        <Modal.Title>{topicToEdit ? "Edit my topic" : "Contribute"}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      ...
      <Modal.Footer>
        <Button type="submit" form="createEditTopicForm" disabled={isSubmitting}>
          Save
        </Button>
      </Modal.Footer>
    </Modal>
